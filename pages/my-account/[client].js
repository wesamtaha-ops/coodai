          ...
          <div className='row' style={{ padding: 0 }}>
            <div className='col-lg-12' style={{ padding: 0, paddingRight: 20 }}>
              ...
              {botDirectories.map((botDirectory) => (
                <div
                  key={botDirectory}
                  class=' flex flex-col justify-between w-40 border rounded relative overflow-hidden'>
                  <Link
                    href={`/upload-and-train/${clientName}/${botDirectory}`}>
                    <img
                  ...
                  <div className='px-1 flex justify-center items-center h-14'>
                    ...
                    <div>
                      <button
                        ...
                        onClick={() => handleDeleteBot(botDirectory)}>
                        Delete
                      </button>
                      <button
                        className='btn btn-primary btn-sm ml-2'
                        style={{ marginBottom: 10 }}
                        onClick={() => handleRenameModalOpen(botDirectory)}>
                        Edit
                      </button>
                    </div>
                  </div>
                ...
                <div className='card progressCard'>
                  ...
                  <div className='card-body'>
                    <div className='mb-3'>
                      ...
                      <ProgressBar
                        now={(availableCredits / totalCredits) * 100}
                        label={`${availableCredits} / ${totalCredits}`}
                      />
                    </div>
                    <div>
                      <p className='card-text'>Available storage</p>
                      <ProgressBar
                        now={(availableStorage / totalStorage) * 100}
                        label={`${availableStorage} MB / ${totalStorage} MB`}
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className='card'>
                  ...
                  <div className='card-body'>
                    ...
                    <button
                      ...
                      className='btn btn-success'>
                      {' '}
                      50000 message / month for $249.99{' '}
                    </button>
                  </div>
                </div>
                <br />
